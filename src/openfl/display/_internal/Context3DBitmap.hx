...
class Context3DBitmap
{
	public static function render(bitmap:Bitmap, renderer:OpenGLRenderer):Void
	{
		...
		if (bitmap.__bitmapData != null && bitmap.__bitmapData.__isValid)
		{
			...
			var shader = renderer.__initDisplayShader(bitmap.__worldColorTransform.__offsetActive(true) ? cast bitmap.__worldShader : renderer.__defaultDisplayShaderFast);			renderer.setShader(shader);
